...
import chat.image.photo.views.CheckedImageButton;
...
public class EmoticonPickerView extends LinearLayout implements IEmoticonCategoryChanged {
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.im_emoji_layout, this);
    }
    ...
    private void loadStickers() {
        ...
        btn.setNormalImageId(R.drawable.im_emoji_icon_inactive);
        btn.setCheckedImageId(R.drawable.im_emoji_icon);
    ...
    private CheckedImageButton addEmoticonTabBtn(int index, OnClickListener listener) {
        ...
        emotBtn.setNormalBkResId(R.drawable.im_sticker_button_background_normal_layer_list);
        emotBtn.setCheckedBkResId(R.drawable.im_sticker_button_background_pressed_layer_list);
        emotBtn.setId(index);
