...
/**
 * Description: SparseArray重写类，用于intent传递
 * Created  by: weyko on 2016/8/9.
 */
public class SparseArrayList<E> extends SparseArray<E> implements Serializable {
    private static final long serialVersionUID = 824056058663678001L;
