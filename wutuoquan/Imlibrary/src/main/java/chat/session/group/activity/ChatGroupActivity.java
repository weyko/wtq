...
/**
 * @author weyko
 * @ClassName: ChatGrupActivity
 * @Description: 群组
 */
public class ChatGroupActivity extends BaseActivity implements
                ...
                public void convert(ViewHolder helper, final ChatGroupBean item) {
                    ...
                    helper.getConvertView().setOnClickListener(
                            new OnClickListener() {
                                @Override
                                public void onClick(View arg0) {
                                    ChatUtil.gotoChatRoom(ChatGroupActivity.this, item);
                                }
                            });
    ...
    public void getGroups() {
        ...
        mode.httpJsonRequest(Method.GET, URLConfig.CHAT_GRUOP_LIST + IMClient.getInstance().getSSOUserId(), parmas,
                new WRequestCallBack() {
                    ...
                    public void receive(int httpStatusCode, Object data) {
                        ...
                        if (data != null) {
                            ...
                            ShowUtil.showToast(ChatGroupActivity.this, getString(R.string.warning_service_error));
                        }
