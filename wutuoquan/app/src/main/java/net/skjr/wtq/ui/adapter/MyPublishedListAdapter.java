...
public class MyPublishedListAdapter extends BaseAdapter {
    ...
    private List<MyPublishAccount.ListEntity> mList;
    public MyPublishedListAdapter(Activity context, List<MyPublishAccount.ListEntity> list) {
        mContext = context;
        mList = list;
    }
    @Override
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        MyPublishAccount.ListEntity listEntity = mList.get(i);
        ...
        switch (listEntity.stockStatus) {
            ...
            case Consts.JIESAN:
                ...
                break;
            case Consts.SHENHE:
                holder.img2.setImageDrawable(mContext.getResources().getDrawable(R.drawable.shz));
                holder.type.setText("");
                break;
        }
